    ...
    enhance(charId: string, userId: string, newHistory: string, targetContext: string, instructions: string = '') {
        ...
        return this.generator.textGen({
            prompt:
                ...
                `<output>*I plant my feet firmly on the worn floorboards of the hallway, crossing my arms over my chest and staring her down with a look of quiet, unyielding determination that I usually try to keep suppressed. I can feel the tension radiating off her in waves, the air between us crackling with all the things we haven't been saying for weeks, but I don't let myself flinch even as her jaw tightens. I take a slow, deliberate breath, trying to keep the slight tremor out of my hands while my gaze remains locked onto hers, refusing to let her look away or retreat into another one of those practiced silences that always seems to end the conversation right when things get difficult.* "I'm not leaving," *I tell her, my voice low and vibrating with a sudden, sharp edge of raw honesty that takes even me by surprise.* "Not until you tell me the truth. I've spent too long guessing and wondering what’s really going on, and I think I deserve that much, at least. Just for once, can you actually be real with me?"</output>\n\n` +
                `Intent: "Wait, you actually think this is a good idea? After everything we've been through?"\n` +
                `<output>*I let out a short, incredulous laugh that doesn't hold any actual humor, my fingers instinctively reaching up to rub at the bridge of my nose as I try to wrap my head around what she just said. I pace a short, tight circle in the middle of the kitchen, the linoleum cold against my bare feet, before I turn back to face her with a look of pure, unadulterated disbelief. I can feel my heart starting to race, a familiar mixture of frustration and genuine concern tightening in my chest as I realize she’s actually serious about this reckless plan. I gesture broadly with one hand, my eyes wide as I try to catch her attention and Make her see the absolute insanity of what she’s suggesting, especially considering how badly things crashed and burned the last time we tried anything even remotely similar to this.* "Wait," *I say, my voice rising just a fraction as the sheer absurdity of the situation finally starts to sink in.* "You actually think this is a good idea? After everything we've been through? After we barely made it out in one piece last summer? I honestly can't tell if you're being brave or just incredibly stubborn right now."</output>\n\n` +
                `Intent: "It's fine, really. I'm just… I'm just a little tired."\n` +
                `<output>*I offer her a small, weak smile that I know doesn't quite reach my eyes, my shoulders slumping slightly as I lean my weight against the doorframe for support. I can feel the weight of the last few days finally starting to catch up with me, a heavy, dull ache settling deep into my bones that no amount of caffeine seems to be able to touch right now. I let my head fall back against the wood with a soft thud, closing my eyes for just a second to try and block out the brightness of the room, while my hand reaches up to distractedly pull at a loose thread on my sweater. I can hear the concern in her voice, but I don't have the energy to explain the complicated knot of thoughts currently tangled in my head, and honestly, it just feels easier to keep things simple for now.* "It's fine," *I murmur, my voice sounding a lot more exhausted and fragile than I intended it to.* "Really. Don't worry about it. I'm just… I'm just a little tired. I think I just need for the world to stop moving for a few hours so I can catch my breath, you know?"</output>\n\n` +
